package com.zzh.myweather.activity;
...
//            address = "http://apis.map.qq.com/ws/district/v1/list?key=OB4BZ-D4W3U-B7VVO-4PJWW-6TKDJ-WPB77";
        }
        showProgressDialog();
